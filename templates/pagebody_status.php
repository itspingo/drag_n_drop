...
*
*/
if(group_access_rights($clientid, $usrid, $usrtype, $applicname, "#modulename", 'status') != 1) {
	$_SESSION['error']="Insufficient Privileges";
	//header('Location: ' . $_SERVER['HTTP_REFERER']); exit;
}
	$statusto = $_POST['actions'];
    
	$count=count($_POST['eid']);
	for ($i=0; $i < $count; $i++) { 
		$sqldel = "update #tablename set active = '".$statusto."' where id = '".intval($_POST['eid'][$i])."'";
